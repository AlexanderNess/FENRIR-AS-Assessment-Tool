...
# Function to render questions with slightly larger text and reduced spacing
def larger_text(text):
    st.markdown(f"<p style='font-size: 1.05em; margin-bottom: -0.2em;'>{text}</p>", unsafe_allow_html=True)

# Function to add more space before subheaders
def space_before_subheader():
...
# Add space before the next subheader
space_before_subheader()
